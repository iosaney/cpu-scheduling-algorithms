...
function calculateSjf() {
  ...
  if (numberOfProcesses > 0) {
    ...
    document.getElementById("aatValues").innerText = avgTurnaroundTime;
    document.getElementById("awtValues").innerText = avgWaitingTime;
    document.getElementById("throughput").innerText = throughput.toFixed(2);
